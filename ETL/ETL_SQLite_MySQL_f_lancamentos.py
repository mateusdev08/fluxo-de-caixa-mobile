...
def etl_dw():
    ...
    db.conectar_db()
    tabela_oltp = db.cursor.execute('select * from financeiro_flancamento;').fetchall()
    ...
    with open(r'C:\Users\Winchester-PC\Desktop\fluxo-de-caixa-django\log\log_flancamentos.log', 'a', encoding='UTF-8') as log_file:
        log_file.write(
